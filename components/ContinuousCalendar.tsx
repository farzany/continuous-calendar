        ...
        {week.map(({ month, day }, dayIndex) => {
          ...
          return (
            <div
              ...
              // className={`relative z-10 m-[-0.5px] group aspect-square w-full grow cursor-pointer rounded-xl font-medium transition-all hover:z-20 sm:-m-px sm:size-20 sm:rounded-2xl lg:size-36 lg:rounded-3xl 2xl:size-40 hover:border hover:border-cyan-400`}
              className="relative z-10 m-[-0.5px] group aspect-square w-full grow cursor-pointer rounded-xl font-medium transition duration-50 ease-in-out hover:z-20 sm:-m-px sm:size-20 sm:rounded-2xl lg:size-36 lg:rounded-3xl 2xl:size-40 border border-white hover:border-cyan-400"
            >
              <span
